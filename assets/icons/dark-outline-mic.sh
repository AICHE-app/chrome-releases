...
# Create DARK outline microphone icons
# Chrome will auto-invert for dark themes
...
# 32px - Dark outline microphone (will be inverted to white in dark mode)
...
echo "Dark outline microphone icons created!"
